...
author: "Geanderson E. dos Santos"
output: html_document
---

## 1: Synopsis
The goal of the assignment is to explore the NOAA Storm Database and explore the effects of severe weather events on both population and economy. The database covers the time between 1950-2011.

This work investigates which types of severe weather are more harmful.
...
Here, I explain how the data is processed.
...
download.file(fileUrl, destfile = paste0("/home/geanderson/sources/coursera/reproducible-research-p2", '/repdata%2Fdata%2FStormData.csv.bz2'))
stormDF <- read.csv("/home/geanderson/sources/coursera/reproducible-research-p2/repdata%2Fdata%2FStormData.csv.bz2")
...
Here, I show the results from the analysis.
